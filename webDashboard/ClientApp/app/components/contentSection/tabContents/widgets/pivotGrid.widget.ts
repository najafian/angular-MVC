...
export class PivotGridWidget extends BaseWidget {
    widget!: ej.PivotGrid;
    ...
    init(containerID: string): void {
        ...
        // renderer.setAttribute(this.rootEl,'style','direction:ltr !important;');
    }

    createWidget(): void {
            let pivot_dataset = this.getValues();
            this.widget = new ej.PivotGrid($('#' + this.rootElID), {
                dataSource: {
                    data: pivot_dataset,
                    // rows: [
                    //     {
